...
def test_no_dropout_produces_identical_views():
    print(
        "\n"
        + "=" * 60
    )
    ...
    print(
        "\nNo-dropout deterministic views: PASSED"
    )

def test_fixed_dropout_mask():
    print(
        "\n"
        + "=" * 60
    )
    print(
        "TEST 4: FIXED DROPOUT MASK"
    )
    print(
        "=" * 60
    )
    ...
    print(
        "\nFixed-mask deterministic views: PASSED"
    )
...
if __name__ == "__main__":
    main()
    test_no_dropout_produces_identical_views()
    test_fixed_dropout_mask()